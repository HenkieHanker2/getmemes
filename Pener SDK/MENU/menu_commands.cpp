...
////				Vector2D(size.x - 1, 2),
////				CColor(65, 244, 235), CColor(58, 209, 201));
////
////			std::string name1 = "getmem";
////			std::string name2 = ".es";
////
////			Vector2D textsize = RENDER::GetTextSize(info.font, name1);
////
////			RENDER::DrawF(position.x + 322, position.y + (WINDOW_TITLE_BAR_SIZE * 0.5f) + 2,
////				info.font, true, true, colors[WINDOW_TEXT], name1);
////
////			RENDER::DrawF(position.x + textsize.x + 324, position.y + (WINDOW_TITLE_BAR_SIZE * 0.5f) + 2,
////				info.font, true, true, CColor(58, 209, 201), name2);
////
...
////					CColor(58, 209, 201), CColor(0, 0, 0, 200));
////			}
////
...
////				RENDER::DrawGradientRectangle(Vector2D(position.x, position.y + 4),
////					Vector2D(filled_x_position - position.x, 6), CColor(58, 209, 201), CColor(0, 0, 0, 200));
////
////				/*
...
////				RENDER::DrawF(position.x + 210, center.y, info.font, false, true,
...
////					value).x + 90), center.y + 10, info.font, false, true, colors[SLIDER_TEXT], value);
////			}
////
////		}
