...
namespace FONTS
{
	...
	void InitFonts()
	{
		...
		menu_window_font = RENDER::CreateF("Tahoma", 14, 500, 0, 0, SDK::FONTFLAG_DROPSHADOW);
		...
		visuals_lby_font = RENDER::CreateF("Verdana", 28, FW_EXTRABOLD, 0, 0, SDK::FONTFLAG_DROPSHADOW);
	}
}
namespace SETTINGS
{
	...
	{
		CreateDirectory("C:\\getmem.es", NULL);

		std::string file_path = "C:\\getmem.es\\" + file_name + ".es";
	...
	{
		std::string file_path = "C:\\getmem.es\\BlankConfig.es";
